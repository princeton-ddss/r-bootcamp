...
- Wickham, Çetinkaya-Rundel, and Grolemund, *R for Data Science*, 2e
  - [Ch. 25: Functions](https://r4ds.hadley.nz/functions.html) (especially §25.1-25.2)
  - [Ch. 26: Iteration](https://r4ds.hadley.nz/iteration.html) (especially §26.1)
- Harvard IQSS, *Math Prefresher for Political Scientists*
  - [Ch. 9: Objects, Functions, Loops](https://iqss.github.io/prefresher/13_functions_obj_loops.html) (especially §§9.4, 9.6, and 9.7)
- R Core Team
  - [`lapply()` documentation](https://stat.ethz.ch/R-manual/R-devel/library/base/html/lapply.html)
