...
## First, ignore the build output

<hr><br>

Before publishing anything, add to `.gitignore`:
...
* renders the site
* creates a `gh-pages` branch, locally and on GitHub
* copies the rendered output onto it
* pushes
...
::: {.fragment}
To update the site later: edit, commit, push, then run
...
::: {.fragment}
* For a **user site** (`janedoe.github.io`), after the first publish go to
  **Settings → Pages** and\
  set the source branch to `gh-pages`.
:::

::: {.fragment}
* Pages on a **private** repo needs GitHub Pro — free for you through
  GitHub Education.
:::

::: {.fragment}
* Run from your project folder, not while sitting on the `gh-pages`
  branch.
:::
...
See [here](https://princeton-ddss.github.io/r-bootcamp/files/website-r-group.pdf).
